      ...
      <section className="py-8">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-4 px-4">
          <div className="mx-auto p-2 hover:scale-105">
            <a
              href="#"
              className="block max-w-sm p-6 border border-gray-200 rounded-lg shadow hover:bg-gray-500 group"
            >
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 group-hover:text-white">
                Mine Ventilation and Air Quality Management
              </h5>
              <p className="font-normal text-gray-700 group-hover:text-white">
                Explore techniques for managing ventilation systems and ensuring
                air quality to protect miners' health.
              </p>
            </a>
          </div>
          ...
          <div className="mx-auto p-2 hover:scale-105">
            ...
            >
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 group-hover:text-white">
                Explosives and Blasting Safety Training
              </h5>
              <p className="font-normal text-gray-700 dark:text-gray-400 group-hover:text-white">
                Master the safe handling, storage, and use of explosives in
                mining operations to minimize risks.
              </p>
            </a>
          </div>
          <div className="mx-auto p-2 hover:scale-105">
            ...
            >
              ...
              <p className="font-normal text-gray-700 dark:text-gray-400 group-hover:text-white">
                Learn critical safety measures and equipment usage for working
                safely at heights in mining environments.
              </p>
            </a>
          </div>
          <div className="mx-auto p-2 hover:scale-105">
            ...
            >
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 group-hover:text-white">
                Occupational Health and Dust Control
              </h5>
              <p className="font-normal text-gray-700 dark:text-gray-400 group-hover:text-white">
                Understand the health risks of mining dust, learn strategies to
                control exposure and safeguard workers' well-being.
              </p>
            </a>
          </div>
        </div>
