  ...
  return (
    <div>
      <div>
        ...
        <section className="ezy__blogdetails5 light py-14 md:py-24 bg-white text-zinc-900 ">
  <div className="container mx-auto px-4">
    <div className="grid grid-cols-12 gap-5 md:gap-7">
      ...
      <div className="col-span-12 md:col-span-4 lg:col-span-3 order-2 md:order-1">
        <div>
          <div>
            <h4 className="text-2xl font-medium mb-2">LESSON NAME</h4>
      ...
      <div className="col-span-12 md:col-span-8 lg:col-span-9 order-1 md:order-2">
        <div>
          ...
          />
           <h4 className="mt-6 font-medium text-2xl opacity-75">
            7 Steps to Master Adobe Illustrator
          </h4>
